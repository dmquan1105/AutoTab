...
class EvidenceExtractor:
    ...
    def extract(self, keyword: str, source_range: str, cells: list[dict[str, Any]]) -> Evidence:
        ...
        for attempt in range(2):
            try:
                retry_hint = "\nReturn valid JSON only; do not include any additional text." if attempt else ""
                raw = str(self.model.complete(prompt + retry_hint))
